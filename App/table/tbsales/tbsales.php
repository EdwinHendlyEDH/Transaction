...
$data = query('SELECT * FROM `tbsales`');

if(isset($_GET['search'])){
    $data = find($_GET['search'], 'tbsales');
}
...
<head>
    ...
    <title>Pengelolaan Sales | Transaksi</title>
            ...
            <div class="sidebar-content">
                <section class="sidebar-section search-bar">
                    <form action="" method="get">
                        <input type="text" placeholder="Search..." name="search" class="search-input tbsales" id="search-input">
                ...
                <section class="sidebar-section">
                    ...
                    <ul class="pengelolaan-links">
                        ...
                        <li class="active"><a href="../tbsales/tbsales.php">Pengelolaan Sales</a></li>
                    </ul>
                </section>
            </div>
        </div>
        <div class="content">
            <h1 class="tb-title">Pengelolaan <span>Sales</span></h1>
            <div class="functionality">
                <a href="./create.php" class="function-button create">
                    <i class="fa-solid fa-drumstick-bite"></i>
                    <div class="function-content">
                        <h2>New Sales</h2>
                        <p>just add new sales</p>
                    </div>
            ...
            <div class="cards" id="cards">
                ...
                <?php }else if(count($data) === 1){ ?>
                    ...
                    <a class="card card-only-one" href="single_sales.php?id=<?=$data[0]['kodesales']?>">
                ...
                <?php }else{; ?>
                    ...
                    <a class="card" href="single_sales.php?id=<?=$data[$i]['kodesales']?>">
                        <div class="card-image">
