...
<head>
    ...
    <title>Supplier | <?=$data['nama']?></title>
    ...
    <div class="page">
        ...
        <div class="content">
            ...
            <div class="functionality">
                <a href="./tbsupplier.php" class="function-button back">
                    <i class="fa-solid fa-angle-left"></i>
                    <div class="function-content">
                        <h2>Back</h2>
                        <p>Back to Pengelolaan Supplier</p>
                    </div>
                </a>
