...
$data = query('SELECT * FROM `tbpelanggan`');
...
<head>
    ...
    <title>Pengelolaan Customer | Transaksi</title>
            ...
            <div class="sidebar-content">
                <section class="sidebar-section search-bar">
                    <form action="" method="get">
                        <input type="text" placeholder="Search..." name="search" class="search-input tbpelanggan" id="search-input">
        ...
        <div class="content">
            ...
            <div class="cards" id="cards">
                ...
                <?php }else if(count($data) === 1){ ?>
                    ...
                    <a class="card card-only-one" href="single_pelanggan.php?id=<?=$data[0]['kodepel']?>">
